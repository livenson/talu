...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedCluster":        schema_pkg_apis_tenancy_v1alpha1_ManagedCluster(ref),
		"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterList":    schema_pkg_apis_tenancy_v1alpha1_ManagedClusterList(ref),
		"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterSpec":    schema_pkg_apis_tenancy_v1alpha1_ManagedClusterSpec(ref),
		"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterStatus":  schema_pkg_apis_tenancy_v1alpha1_ManagedClusterStatus(ref),
		"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterWorkers": schema_pkg_apis_tenancy_v1alpha1_ManagedClusterWorkers(ref),
		"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.Tenant":                schema_pkg_apis_tenancy_v1alpha1_Tenant(ref),
...
func schema_pkg_apis_tenancy_v1alpha1_ManagedCluster(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ManagedCluster is a tenant's own Kubernetes cluster on the same substrate (KaaS).\n\nNamed ManagedCluster, not Cluster: cluster.x-k8s.io/Cluster already runs on this substrate (CAPI drives KaaS), and a second `kubectl get cluster` would be ambiguous for operators.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterSpec", "github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_tenancy_v1alpha1_ManagedClusterList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedCluster"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedCluster", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_tenancy_v1alpha1_ManagedClusterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"projectUuid": {
						SchemaProps: spec.SchemaProps{
							Description: "ProjectUUID is the manager join key stamped on every rendered object.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"kubernetesVersion": {
						SchemaProps: spec.SchemaProps{
							Description: "KubernetesVersion must have a matching capk container-disk image.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"controlPlaneReplicas": {
						SchemaProps: spec.SchemaProps{
							Description: "ControlPlaneReplicas spread across management nodes.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"workers": {
						SchemaProps: spec.SchemaProps{
							Description: "Workers sizing. Replicas is ignored once autoscaling is enabled — the autoscaler owns it.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterWorkers"),
						},
					},
					"adminUser": {
						SchemaProps: spec.SchemaProps{
							Description: "AdminUser gets cluster-admin inside the tenant cluster via the Pomerium impersonation route.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"backup": {
						SchemaProps: spec.SchemaProps{
							Description: "Backup enables in-tenant Velero DR; the endpoint, bucket and credentials are the site's.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
		...
		Dependencies: []string{
			"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.ManagedClusterWorkers"},
	}
}

func schema_pkg_apis_tenancy_v1alpha1_ManagedClusterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_tenancy_v1alpha1_ManagedClusterWorkers(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_pkg_apis_tenancy_v1alpha1_Tenant(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.TenantSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.TenantStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.TenantSpec", "github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.TenantStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_tenancy_v1alpha1_TenantList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.Tenant"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/livenson/talu/apiserver/pkg/apis/tenancy/v1alpha1.Tenant", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_pkg_apis_tenancy_v1alpha1_TenantSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"projectUuid": {
						SchemaProps: spec.SchemaProps{
							Description: "ProjectUUID is stamped on every rendered object as talu.io/project-uuid — the manager join key.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
					...
					"members": {
						SchemaProps: spec.SchemaProps{
							Description: "Members are the emails allowed to SSH into this tenant's VMs and hold its scoped RBAC role.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
					...
					"quota": {
						SchemaProps: spec.SchemaProps{
							Description: "Quota maps directly to the rendered ResourceQuota's hard limits (e.g. requests.cpu: \"4\").",
							Type:        []string{"object"},
					...
					"dashboards": {
						SchemaProps: spec.SchemaProps{
							Description: "Dashboards renders the per-tenant Perses + prom-label-proxy stack.",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
					"networkBaseline": {
						SchemaProps: spec.SchemaProps{
							Description: "NetworkBaseline flips the tenant's VMs to default-deny (Layer B).",
							Type:        []string{"boolean"},
							Format:      "",
						},
					},
...
func schema_pkg_apis_tenancy_v1alpha1_TenantStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"conditions": {
						SchemaProps: spec.SchemaProps{
							Description: "Conditions are projected from the backing HelmRelease.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"size": {
						SchemaProps: spec.SchemaProps{
							Description: "Size is a named size backed by a VirtualMachineClusterInstancetype (components/tenancy/sizes/). KubeVirt rejects a VM that overrides its instancetype, so a size is enforced, not advisory — and it is the only way this API expresses vCPU at all.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"principal": {
						SchemaProps: spec.SchemaProps{
							Description: "Principal is the guest OS user and SSH certificate principal.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"rootDiskSize": {
						SchemaProps: spec.SchemaProps{
							Description: "RootDiskSize applies when the site's image catalog uses a persistent DataVolume.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"guestSecretsRef": {
						SchemaProps: spec.SchemaProps{
							Description: "GuestSecretsRef names a Secret rendered into the guest as /etc/talu/app.env.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"securityGroups": {
						SchemaProps: spec.SchemaProps{
							Description: "SecurityGroups are the tenant security groups this VM joins; they become labels the tenant's CiliumNetworkPolicies select on.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
