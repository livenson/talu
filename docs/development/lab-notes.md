...
44. **`virt-customize` against a CDI-imported PVC needs TWO things the image does not give you, and
...
45. **CDI v1.65.0 DOES decompress `zstd` — measured, not assumed.** Imported the same cirros disk
